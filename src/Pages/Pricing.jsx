  ...
  <div className="container">
    <div className="panel pricing-table">
      ...
      <div className="pricing-plan">
        ...
        <NavLink to="" className="pricing-button">Sign up</NavLink>
      </div>
      ...
      <div className="pricing-plan">
        ...
        <span className="pricing-price">Free</span>
        <NavLink to="" className="pricing-button is-featured">Free trial</NavLink>
      </div>
      ...
      <div className="pricing-plan">
        ...
        <span className="pricing-price">Free</span>
        <NavLink to="" className="pricing-button">Free trial</NavLink>
      </div>
